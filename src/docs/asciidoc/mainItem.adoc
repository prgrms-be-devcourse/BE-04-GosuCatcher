...
.Request
include::{snippets}/mainItem-create/http-request.adoc[]

include::{snippets}/mainItem-create/request-fields.adoc[]

.Response
include::{snippets}/mainItem-create/http-response.adoc[]

include::{snippets}/mainItem-create/response-fields.adoc[]
